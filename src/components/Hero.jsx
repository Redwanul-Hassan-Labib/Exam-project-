...
const Hero = () => {
  return (
    <div className="bg-[#FFE9D9] ">
      <div className="bg-secondary relative pt-[60px] pb-[125px] border border-black border-t-[1px]">
        <div className="container">
          <div className="grid grid-cols-1 2xl:-mx-4">
            <div className="xl:pt-12">
              <span className="font-Syne text-black-800 font-bold text-2xl lg:text-[32px] leading-none flex flex-wrap items-center mb-3">
                <span className="mr-6">
                  <svg
                ...
                <p className="text-[#000]">Hello, I’m</p>
              </span>
              <h1 className="relative z-[1] font-Syne text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] 2xl:before:w-[120px] xl:before:w-[100px] 2xl:before:h-[120px] xl:before:h-[100px] before:rounded-full before:bg-primary before:block before:absolute before:top-[0px] before:left-0 before:-z-[1] lg:before:w-[85px] lg:before:h-[85px] before:w-[70px] before:h-[70px] text-black">
                Mark
              </h1>
              <h2 className="font-Syne text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px] text-black">
                Henry
              </h2>
              <p className="font-Syne text-black-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-[30px] text-black">
              ...
              <div className="flex flex-wrap mb-[50px] md:mb-[60px] xl:mb-[70px] 2xl:mb-[80px]">
                <span>
                  <a
                    href="contact.html"
                    className="flex items-center flex-wrap btn-primary mr-2 group text-black"
                  >
                    Let’s Talk
                ...
                <span data-aos="fade-right" data-aos-delay="1200">
                  <a
                    href="projects.html"
                    className="flex items-center flex-wrap btn-primary-outline group text-black"
                  >
                    My Work
                    <span className="inline-block ml-3 group-hover:animate-arrow-move-up">
                      <svg
              ...
              >
                <div className="flex flex-wrap items-center">
                  <span className="font-Syne text-black-800 font-bold text-[44px] leading-none text-black">
                    <span className="counter text-black">1.2</span>k+
                  </span>
                  <span className="text-lg text-black-700 ml-3 text-black">
                    Worldwide client
                  </span>
                  <span className="mx-8">
                    <svg
        ...
        <div className="hidden md:block container relative">
          <Image
            src={HeroImage}
            className="absolute xl:top-[-600px] lg:top-[-465px] top-[-600px]   right-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[650px] 2xl:max-w-[initial]"
            alt="Image"
          />

          <a href="#">
            <svg
              className="absolute bottom-[-85px] lg:bottom-[-130px] xl:bottom-[-110px] right-[40px] lg:right-[150px] xl:right-[150px]"
              width="180"
              height="180"
              viewBox="0 0 180 180"
              fill="none"
